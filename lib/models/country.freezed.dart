...
class _$_Country implements _Country {
  const _$_Country({required this.uuid, required this.tag, required this.name});
  ...
  @override
  String toString() {
    return 'Country(uuid: $uuid, tag: $tag, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, uuid, tag, name);
