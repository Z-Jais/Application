...
class _$_Manga implements _Manga {
  ...
  @override
  String toString() {
    return 'Manga(uuid: $uuid, platform: $platform, anime: $anime, hash: $hash, releaseDate: $releaseDate, url: $url, cover: $cover, editor: $editor, ref: $ref, ean: $ean, age: $age, price: $price)';
  }
...
abstract class _Manga implements Manga {
  const factory _Manga(
      ...
      required final int? ean,
      required final int? age,
      required final double? price}) = _$_Manga;
